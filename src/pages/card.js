...
const Card = ({itemName, value}) => {
    ...
    const renderContributors = (users) => {
        if(contributors) {
            ...
            return (
                <React.Fragment>
                    <Tr>
                        ...
                        <Td>Stargazers:<br/>{repo.stargazers_count}</Td>
                        <Td>Last commit:<br/>{repo.pushed_at}</Td>
                    </Tr>
                    <Tr>
                        <Td><Img src={repo.owner.avatar_url} alt="avatar" /></Td>
                        <Td>Nickname:<br/>{repo.owner.login}</Td>
                        <Td><a href={repo.owner.html_url}>{repo.owner.html_url}</a></Td>
                    </Tr>
                    <Tr>
                        <Td block>Languages:<br/>{repo.language}</Td>
                    </Tr>
                    <Tr>
                        <Td block>Description:<br/>{repo.description}</Td>
                    </Tr>
                    <Tr>
